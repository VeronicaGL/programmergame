      ...
      <div className="mt-2 sm:mx-auto sm:w-full sm:max-w-sm">
        <form onSubmit={handleSubmit(handleLogin)} className="space-y-2">
          ...
          <div className="mt-4">
            <button
              type="submit"
              className="w-full flex justify-center py-2 px-4 shadow-lg shadow-indigo-500/75 bg-purple-700 opacity-50 transition ease-in-out hover:-translate-y-1 hover:scale-110 duration-150 text-white rounded mt-6"
            >
              Iniciar Sesión
            </button>
          </div>
